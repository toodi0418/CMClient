...
Fields named like API keys, authorization, passcodes, passwords, secrets, or
tokens are recursively redacted before any logger receives them. Logging and
API error handling must never use request payloads as a convenience dump.
